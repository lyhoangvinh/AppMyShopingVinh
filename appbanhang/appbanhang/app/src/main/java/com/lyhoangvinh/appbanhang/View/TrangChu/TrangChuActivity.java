...
import com.lyhoangvinh.appbanhang.Adapter.ExpandAdater;
import com.lyhoangvinh.appbanhang.Adapter.ViewPagerAdapter;
...
import com.lyhoangvinh.appbanhang.Presenter.ChiTietSanPham.PresenterLogicChiTietSanPham;
import com.lyhoangvinh.appbanhang.Presenter.TrangChu.XuLyMenu.PresenterLogicXuLyMenu;
import com.lyhoangvinh.appbanhang.R;
import com.lyhoangvinh.appbanhang.View.DangNhap_DangKy.DangNhapActivity;
import com.lyhoangvinh.appbanhang.View.GioHang.GioHangActivity;
import com.lyhoangvinh.appbanhang.View.TimKiem.TimKiemActivity;
...
public class TrangChuActivity extends AppCompatActivity implements ViewXuLyMenu,GoogleApiClient.OnConnectionFailedListener,AppBarLayout.OnOffsetChangedListener{
    ...
    public static final String SERVER_NAME = "http://192.168.1.102/weblappbanhang/loaisanpham.php";
    public static final String SERVER= "http://192.168.1.102/weblappbanhang";
    Toolbar toolbar;
    TabLayout tabLayout;
    ViewPager viewPager;
